...
# Программа вычисляет приближенное значение интеграла для N1 и N2 участков
# разбиения функции. Затем для менее точного метода итерационно определяет
# количество участков разбиения, для которого интеграл вычислен с заданной
# точностью. Далее по введенному значению первообразной вычисляет
# абсолютную и относительную погрешности интегрирования
