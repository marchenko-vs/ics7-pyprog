# Программа вычисляет длины сторон треугольника и высоты, проведенной из 
# из наибольшего угла, определяет, принадлежит ли заданная точка треугольнику,
# находит расстояние от нее до ближайшей стороны, определяет, тупой ли треугольник
