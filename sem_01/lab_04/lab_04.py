...
# Программа вычисляет таблицу значений функций с помощью оператора while.
# Выводит все значения в таблицу. Затем строит график функции p2(t).
# На оси y наносит равномерное кол-во засечек, заданное пользователем.
# Определяет суммы отрицательных значений p1 и p2.
