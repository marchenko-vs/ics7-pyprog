# Автор программы - Марченко Владислав. Группа ИУ7-13Б. С помощью программы можно создать базу данных в бинарном
# файле, добавлять записи в БД, смотреть эти записи, искать записи по одному или двум ключевым полям
