# Автор программы Марченко Владислав Сергеевич (ИУ7-13Б)
# Лабораторная работа №7
# Программа поворачивает заданную квадратную матрицу на 180 градусов,
# затем из двух списков A и B формирует матрицу F по правилу f[i][j] = a[i] * b[j]
# После этого для каждого столбца матрицы F программа определяет среднее
# арифметическое элементов и количество элементов, превышающих среднее арифметическое
